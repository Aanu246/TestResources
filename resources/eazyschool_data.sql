...
INSERT INTO `roles` (`role_name`,`created_at`,created_by)
 ...
 DELETE FROM person where  email= 'aanukayode2@gmail.com';
 INSERT INTO `person`(`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`,`created_by`)
 	VALUES('Admin','aanukayode2@gmail.com','09063074615','$2a$12$ILalDmomImKnPNN9JkhnbuqmiJxI/E6W2BtBLNPZ4MEF625s9Oeyi', 1 ,CURDATE(),'DBA');
