...
public class AdminController {	
	...
	public ModelAndView displayClassses(Model model) {
	...
	public ModelAndView deleteStudent(Model model, @RequestParam int personId, HttpSession session){
		...
		//here we break the link between class and person
	...
	//Courses code
		...
		public ModelAndView displayCourses(Model model) {
			...
			//Static sorting
			//test findByOrderByNameDesc() too
		...
		public ModelAndView deleteStudentFromCourse(Model model, @RequestParam int personId, HttpSession session){
			Courses courses  =(Courses) session.getAttribute("courses");
			Optional<Person> person = personRepository.findById(personId);
			//here we break the link between courses and person
